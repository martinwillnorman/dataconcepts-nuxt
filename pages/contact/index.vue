<template>
  <div class="__page-root">
    ...
    <div class="sections">
      ...
      <section>
        <nuxt-link class="join-us-link" to="/careers">
...
.clock
  border-radius: 50%
  background-image:  url(~assets/image/clock/clock.png)
...
.join-us-link
  ...
  width: 100%
  height: 800px
  background-image: url(~assets/image/people/people-2.jpg)
  background-size: cover
...
.join-us-link:hover:after
  background-color: rgba(0,0,0,0.7)

.join-us-link:hover .arrow-wrapper
  padding-left: 10%
